...
var DocForm = function (_React$Component) {
  ...
  _createClass(DocForm, [{
    ...
    value: function onChange(res) {
      ...
      this.props.onChange({ key: key, value: value, isValid: isValid, initialValue: initialValue, updateData: updateData, event: event, resParameters: resParameters });
    }
  }, {
    key: 'onFocus',
    value: function onFocus(res) {
      ...
      var initialValue = this.fieldsInitialValue[key];
      onFocus && onFocus({ key: key, value: value, isValid: isValid, initialValue: initialValue, event: event, resParameters: resParameters });
    }
  }, {
    key: 'onBlur',
    value: function onBlur(res) {
      ...
      var initialValue = this.fieldsInitialValue[key];
      onBlur && onBlur({ key: key, value: value, isValid: isValid, initialValue: initialValue, event: event, resParameters: resParameters });
    }
  }, {
